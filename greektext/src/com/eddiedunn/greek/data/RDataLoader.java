    	...
    	try {
    		ArrayList<String> code = new ArrayList<String>();
    	      ...
    	      if( loadExistingWorkspace )
    	    	  code.add("load('C:/Users/tmwsiy/workspace/greek-nlp/greektext/output/"+saveChangesFileName+".RData')");    	          	      
    	      
    	      code.add("rlabels <- scan('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+dataBase+"ManuscriptNameVector.txt',what=character(),sep=',',nlines=1)");
    	      code.add("clabels <- scan('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+dataBase+"FeatureVector.txt',what=character(),sep=',',nlines=1,encoding='UTF-8')");
    	      code.add(dataBase+" <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+dataBase+"IDFFeatureMatrix.txt', header=FALSE)");
    	      code.add(dataBase+".cosine <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+dataBase+"CosineMatrix.txt', header=FALSE)");
    	      ...
    	      code.add(dataBase+".gc <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+dataBase+"GlobalCounts.txt', header=FALSE,encoding='UTF-8')");	
    	      code.add("colnames("+dataBase+".gc) <- c('gram','count')");
    	      code.add(dataBase+".idfgc <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+dataBase+"GlobalIDFCounts.txt', header=FALSE,encoding='UTF-8')");
    	      ...
    	      if(saveChanges)
    	    	  code.add("save('C:/Users/tmwsiy/workspace/greek-nlp/greektext/output/"+saveChangesFileName+".RData')");
	...
	private void readChapters(){
		for (int chapter = 1; chapter <= 25; chapter++) {
			...
			try {
		      ...
		      if( loadExistingWorkspace )
		    	  code.add("load('C:/Users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapSaveChangesFileName+".RData')");
		
		      code.add("library(vegan)");  	     
		      code.add("clabels <- scan('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapDataBase+"FeatureVector.txt',what=character(),sep=',',nlines=1,encoding='UTF-8')");		      
    	      code.add("rlabels <- scan('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapDataBase+"ManuscriptNameVector.txt',what=character(),sep=',',nlines=1)");    	      
    	      code.add(chapDataBase+" <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapDataBase+"IDFFeatureMatrix.txt', header=FALSE)");
    	      code.add(chapDataBase+".cosine <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapDataBase+"CosineMatrix.txt', header=FALSE)");		      		      
    	      ...
    	      code.add(chapDataBase+".gc <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapDataBase+"GlobalCounts.txt', header=FALSE,encoding='UTF-8')");	
    	      code.add("colnames("+chapDataBase+".gc) <- c('gram','count')");
    	      code.add(chapDataBase+".idfgc <- read.csv('c:/users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapDataBase+"GlobalIDFCounts.txt', header=FALSE,encoding='UTF-8')");
    	      ...
    	      if(saveChanges)
     	    	 code.add("save('C:/Users/tmwsiy/workspace/greek-nlp/greektext/output/"+chapSaveChangesFileName+".RData')");
