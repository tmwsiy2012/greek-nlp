...
public class TestCompositeGrams {
	...
	public static void main(String[] args) {
		...
		CU.writeCountMapToFile(tmpGrandCompositeGrams, "compositeGramGlobalCountsFullReducedMore");
		CU.writeVectorToFile(tmp.toArray(new String[0]), "compositeGramFeatureVectorFullReducedMore");
	...
	private static void runCompositeGramTF_IDFFeature(Corpus c, SortedMap<String, Integer> tmpGrandCompositeGrams){
		...
		c.writeCurrentTFIDFFeatureMatrix(tmpGrandCompositeGrams, "CompositeGramIDFFeatureMatrixFullReducedMore");
	}
}
